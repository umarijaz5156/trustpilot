            ...
            <div class="grid">
                <div class="flex justify-center items-center">
                    <div class="mt-10 lg:mt-0 text-center">
                        <h1 class="text-black text-5xl xl:text-7xl leading-tight font-bold">
        ...
        <div class="container xl:max-w-screen-2xl mx-auto px-4 relative">
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
                @foreach ($categories as $category)
                    <div wire:key="category-{{ $category->id }}" class="border border-[#0BA1E5] rounded-[12px] pb-5">
                        <a href="{{ route('categories.business', str_replace(' ', '-', $category->title)) }}" class="flex justify-center items-center gap-2 bg-[#158FC6] pt-12 pb-5 px-4 rounded-[10px]">
                            <img src="{{ asset('storage/' . $category->icon_path) }}" width="80" height="80"
                                alt="">
                        ...
                        <ul class="pt-6 w-full px-5 xl:px-11 space-y-3 max-h-[292px] overflow-y-auto custom-scroll">
                            @foreach ($category->childCategories as $childCategory)
                                <li wire:key="subcategory-{{ $childCategory->id }}">
                                    <a href="{{ route('categories.business', str_replace(' ', '-', $childCategory->title)) }}" class="font-light pl-7 relative">
                                        <i
