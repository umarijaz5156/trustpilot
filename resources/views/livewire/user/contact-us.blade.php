<div>
    <section class="mt-10 p-5 ">
        <div class="container mt-20 xl:max-w-screen-2xl mx-auto px-4">
            <div class="my-2">
                @if (session('success'))
                    ...
                    <div class="flex flex-col justify-between">
                        <div>
                            ...
                            <div class="text-gray-700 mt-8">
                                Hate forms? Send us an <a href="mailto:{{ $adminEmail }}" class="underline">email</a> instead.
                            </div>
                        </div>
                    ...
                    <form wire:submit.prevent="StoreContact">
                        ...
                        <div style="display: flex; align-items: center; justify-content: center;">
                            <div style="flex: 1;">
                                ...
                                @else
                                    <span>No captcha generated.</span>
                                @endif
                            </div>
                            <div>
                                <button style="margin-left: 10px;" wire:click="generateCaptcha" type="button">Refresh</button>
                            </div>
                        </div>
                        
                        <div class="mt-8">
                            <span class="uppercase text-sm text-gray-600 font-bold">Captcha</span>
                        ...
                        <div class="mt-8">
                            <button
                                class="uppercase text-sm font-bold tracking-wide  bg-indigo-500 text-white p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
                                Send Message
                            </button>
                        </div>
                    </form>
