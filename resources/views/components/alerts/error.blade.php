<div x-data="{ show: true }" x-show="show" x-show="show" x-init="setTimeout(() => document.getElementById('alert-border-2').remove(), 10000)" id="alert-border-2" class="flex p-4 mb-4 bg-red-100 border-t-4 border-red-500 dark:bg-red-200" role="alert">
